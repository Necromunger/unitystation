...
public class DoorController : SwitchableBehavior
{
	...
	#region SwitchableBehavior Implementation

	public override void ServerSwitchOpen()
	{
		ServerOpen();
	}

	public override void ServerSwitchClose()
	{
		ServerClose();
	}

	public override void ServerSwitchToggle()
	{
		if (!IsOpened)
		{
			ServerOpen();
